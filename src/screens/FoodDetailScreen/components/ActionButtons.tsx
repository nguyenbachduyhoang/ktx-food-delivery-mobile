...
const ActionButtons: React.FC<ActionButtonsProps> = ({ onAddToCart, onCheckout, delay = 600 }) => {
  return (
    <Animated.View entering={FadeInDown.delay(delay)} style={styles.actionButtons}>
      <Button title="Thêm vào đơn hàng" onPress={onAddToCart} style={styles.addButton} />
      <Button
        title="Thanh toán"
        onPress={onCheckout}
